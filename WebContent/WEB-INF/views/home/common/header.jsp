...
<div class="container">
  <div class="header-topbar hidden-xs link-border">
	<ul class="site-nav topmenu">
	  ...
	  <li><a href="#" >标签云</a></li>
		...
		<li><a href="#" onclick="addFavorite('http://programmer.ischoolbar.com/','JY')" title="RSS订阅" >
			<i class="fa fa-rss">
			</i> RSS订阅
		</a></li>
	</ul>
  ...
  <div class="navbar-header">
	...
	<h1 class="logo hvr-bounce-in"><a href="/News/index/index" title="JY新闻博客网站"><img src="../resources/home/images/logo.png" alt="JY新闻博客网站"></a></h1>
  </div>
  <div class="collapse navbar-collapse" id="header-navbar">
	...
	<ul class="nav navbar-nav navbar-right">
	  <li><a data-cont="JY新闻博客网站" title="JY新闻博客网站" href="/News/index/index">首页</a></li>
